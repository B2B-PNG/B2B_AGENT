...
export const useListBoat = (filters: { page?: number; pageSize?: number, strSupplierGUID?: string | null, tblsReturn?: string }) => {
    const { user } = useUser();
...
const fetchMappingPrice = async (body: any) => {
    const res = await apiClient.post("supplier/GetListSupplierMappingPriceForBoatByAgent", body);
    return res.data;
};

export const useListMappingPrice = (
    filters?: {
        page?: number | null;
