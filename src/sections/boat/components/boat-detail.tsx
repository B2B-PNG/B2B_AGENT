...
import { Filter, MapPin, RotateCcw, Search, Star } from "lucide-react";
import BookingForm from "./booking-form";
import { useListBoat, useListImage, useListMappingPrice } from "@/hooks/actions/useBoat";
                ...
                return (
                    <div className="flex flex-col items-center gap-1">
                        <div className="flex items-center border border-slate-300 rounded overflow-hidden h-8">
                            <button
                                className="cursor-pointer px-2 bg-slate-100 hover:bg-slate-200 text-slate-600 h-full border-r border-slate-300"
                            >
                                -
                            </button>
                            <input
                            ...
                            />
                            <button
                                className="cursor-pointer px-2 bg-slate-100 hover:bg-slate-200 text-slate-600 h-full border-l border-slate-300"
                            >
                                +
                            </button>
                        </div>
                        <span className="text-[10px] text-slate-500 italic">(Có sẵn: 0)</span>
                    </div>
                );
            }
        },
        ...
        },
        {
            ...
            render: (_) => (
                <div className="flex justify-center min-w-[100px]">
                    <button
                        className="cursor-pointer rounded-lg border border-[rgba(64,64,64,0.5)] text-[12px] px-3 py-2 font-medium text-gray-700 hover:text-[#2566b0] hover:bg-blue-50 transition-all duration-200 active:scale-95"
                    >
                        Gửi yêu cầu
                    </button>
                </div>
                ...
                <div className="flex flex-col lg:flex-row gap-8">
                    ...
                    <div className="flex-1 space-y-6">
                        ...
                        <div className="mt-8 space-y-2">
                            <h1 className="text-3xl font-bold text-slate-800 uppercase">{boat?.strSupplierName}</h1>
                        ...
                        <div className="mt-10 space-y-6">
                            ...
                            <div className="flex flex-wrap items-end gap-3">
                                <div className="flex-1 min-w-[200px] space-y-2">
                                    <label className="text-sm font-bold text-slate-700">Tên thuyền</label>
                                    <input
                                        type="text"
