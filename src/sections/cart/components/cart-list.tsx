...
const colDefs: ColumnDef<any>[] = [
  {
    field: "checkbox",
    headerName: "",
    render: () => <input className="w-4 h-4" type="checkbox" />,
  },
  {
    field: "No",
    headerName: "STT",
  ...
  },
  {
    ...
    headerName: "Thao tác",
    render: () => (
      <button className="w-8 h-8 flex items-center justify-center rounded bg-gray-200 hover:bg-gray-300">
        <Trash2 size={14} />
      </button>
    ),
  },
    ...
    <div className="w-full bg-[#f7f8fa] min-h-screen">
      <div className="max-w-[1320px] mx-auto px-6 py-10">
        <div className="mb-8 flex items-center gap-3">
          <h1 className="text-[56px] leading-none font-medium text-[#2d3748]">
            Giỏ hàng
          </h1>

          <div className="flex items-center gap-1 border border-gray-300 rounded-md bg-white px-2 py-2">
            <button
              type="button"
