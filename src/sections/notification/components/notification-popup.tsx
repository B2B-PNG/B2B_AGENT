            ...
            {!isLoading &&
              ...
              listData.map((item: any) => (
                ...
                >
                  <div className="flex gap-3">
                    <div
                      className={`mt-1 h-2 w-2 rounded-full shrink-0 ${item.IsRead ? "bg-transparent" : "bg-blue-500 shadow-[0_0_8px_rgba(59,130,246,0.5)]"}`}
                    />
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="flex items-center gap-1.5 text-[10px] text-gray-400">
                        <Calendar size={12} />
                        <span>{item?.dtmCreatedDateAgentNotifyTo}</span>
                      </div>
                    </div>
                  </div>
                </button>
