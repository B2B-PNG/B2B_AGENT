...
// export const fDayFromCreate = (createdAt?: string) => {
//   if (createdAt) {
//     return dayjs().startOf("day").diff(dayjs(createdAt).startOf("d"), "day");
//   } else return "0";
// };

// export const fDayString = (day?: string) => {
...
// };
// export const fTimestampMs = (dateString?: string) => {
